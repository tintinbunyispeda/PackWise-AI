...
const NAV: Record<AuthUser["role"], Item[]> = {
  engineer: [
    ...
    { title: "Product Analysis", url: "/app/product-analysis", icon: PackageSearch },
    { title: "Packaging Planner", url: "/app/packaging-planner", icon: Boxes },
    { title: "Packaging Preview", url: "/app/packaging-preview", icon: Eye },
