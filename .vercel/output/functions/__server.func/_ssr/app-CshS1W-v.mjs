...
import { a as getUser, s as logout } from "./auth-DIWjK7oO.mjs";
...
import { C as Settings, E as ScanLine, F as LayoutDashboard, N as Link2, P as Leaf, Q as Cog, T as Search, U as FileChartColumn, Y as DollarSign, b as ShieldCheck, c as Users, dt as Bell, j as LogOut, k as PanelLeft, n as X, v as SquareCheckBig, w as Send, x as ShieldAlert } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/app-CshS1W-v.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarFooter, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "flex h-8 w-8 items-center justify-center rounded-full bg-[color:var(--primary-soft)] text-sm font-semibold text-primary",
...
function AppLayout() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SidebarProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppSidebar, { user }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SidebarInset, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			className: "sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border/70 bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/80 sm:px-6",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "pointer-events-none absolute left-2.5 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
						placeholder: "Search analyses, products, reports…",
						className: "h-9 pl-8"
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						className: "hidden sm:flex h-8 w-8 items-center justify-center rounded-full bg-[color:var(--primary-soft)] text-xs font-semibold text-primary",
						children: user.name.split(" ").map((n) => n[0]).slice(0, 2).join("")
					})]
				})
			]
